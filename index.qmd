...
(@) __Introduction to some concepts__
...
## Materials sent {.smaller}

  * Center of Open Science. _Introduction to OSF_. <https://youtu.be/X07mBq2tnMg?si=m_mXwKrw0LvHazTg>

  * Leek, J. _How to share data with a statistician_. <https://github.com/jtleek/datasharing>
...
## {background-image="images/web-cnpq-br.png" background-position="top left" background-size="100%"}
...
* Lack of a project and data management system.
...
## Suggestions for the Global Syndemic project {.smaller}

⚠️ __NOT FINISHED__ ⚠️

#### Project and data management

1. __Use OSF as a project and data management system__
...
1. __Use Wickham's program for data analysis__
...
2. __Dynamic documents__
  * Utilize dynamic documents to maintain an updated and reproducible record of data analyses.
...
4. Reproducible environments
  * Use reproducible environments to ensure that the data analysis is replicable and transparent.
...
## Global Syndemic project on OSF {.smaller}

⚠️ __NOT FINISHED__ ⚠️

## Global Syndemic project on GitHub {.smaller}
